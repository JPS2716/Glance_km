    ...
    <div className={`relative flex items-center justify-center w-full h-full select-none ${className}`}>
      ...
      {markers.map((m) => (
        <div
          ...
          style={{
            position: "absolute",
            // @ts-ignore - CSS anchor positioning is experimental
            ...
            marginBottom: 8,
            padding: "2px 6px",
            background: "#a2c9ff",  // primary blue background
            color: "#004176",       // on-primary text
            ...
            boxShadow: "0 0 10px rgba(162,201,255,0.3)",
